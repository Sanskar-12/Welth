...
// Check Budget Alerts for Accounts and send Mail regarding the alerts
...
// Generate monthly report and mail to the user
  ...
  async ({ step }) => {
    ...
    for (const user of users) {
      await step.run(`generate-report-${user.id}`, async () => {
        ...
        // generate financial insights for  the previous month with using AI
